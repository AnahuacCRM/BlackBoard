...
{
    /// <summary>
    /// WebService para BlackBoard
    /// </summary>
    [WebService(Namespace = "http://BlackBoard.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]
    // Para permitir que se llame a este servicio web desde un script, usando ASP.NET AJAX, quite la marca de comentario de la línea siguiente. 
    // [System.Web.Script.Services.ScriptService]
    public class wsBlackBoard : System.Web.Services.WebService
    {
        public string vsMensaje { get; set; }
        /// <summary>
        /// Servicio que permite invocar a la aplicación responsable de generar los archivos para BlackBoard.
        /// </summary>
        /// <param name="psNumeroEvento">Número de Evento a procesar.</param>
        /// <returns></returns>
        [WebMethod]
